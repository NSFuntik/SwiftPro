...
//
//
//  Created by Dmitry Mikhaylov on 05.03.2024.
//
...
public extension TimeInterval {
     ...
     */
    init (milliseconds: Double) { self = milliseconds / 1_000 }
     ...
     */
    init (hours: Double) { self = hours * 3_600 }
